...
### Display Top Results by Total Affected
...
### Set Progress Bar Detail Level

This variable controls the verbosity of progress bars during optimization. Setting it to 1 enables progress tracking for the main optimization loop.
