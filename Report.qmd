...
This is an internal email meant for daily monitoring of NHC data in the Atlantic basin. It's meant to sanity check out nhc pipeline and cuba hurricane monitoring by giving allowing us to check whether any storms have been detected in our database against the latest NHC publication.
